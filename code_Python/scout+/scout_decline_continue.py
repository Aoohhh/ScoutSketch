...
class scout_sketch():  # headhunter
    ...
    #                 if self.scout[idx][cell][2] == 0:   # 下降起点
    ...
    #                 if self.scout[idx][cell][1] < self.scout[idx][cell][2] * self.P:     # 合法衰减
    #                     self.scout[idx][cell][3] += 1
    #                     self.scout[idx][cell][4] = 0
    #                     self.scout[idx][cell][2] = self.scout[idx][cell][1]
    ...
    #                         our_result.append([self.scout[idx][cell][0],self.scout[idx][cell][5],time_windows,1])
    #                         #print(self.scout[idx][cell])
    ...
    #                         self.scout[idx][cell][4] = 0
    #                 elif self.scout[idx][cell][1] > self.scout[idx][cell][2] * self.Q:  # 增加过多
    ...
    #                 else:
    #                     self.scout[idx][cell][4] += 1   # 当前周期变化不大 不更新最大值
    ...
    #                 # if self.scout[idx][cell][0] == '16.25.141.160'and time_windows > 2525:
    #                 #     print(self.scout[idx][cell])
    #                 # if time_windows >2540 :
    #                 #     sys.exit()
    ...
    #                         global num_promising_flows
    #                         num_promising_flows += 1
    #                         global our_result       # 报告写入real_array中
    #                         our_result.append([self.scout[idx][cell][0],self.scout[idx][cell][5],time_windows,1])
    #                         # 从当前周期重新判定是否为promising flow
    #                         self.scout[idx][cell][3] -= 1
                        ...
                        for T_value in [10]:
                            ...
                            for q in [1.05]:                            
                                ...
                                for judge in [3]:
                                    ...
                                    with open("E:\\research\\grade1\\result\\(decline-stack)memory_"+str(memory)+".txt", "w") as f:
