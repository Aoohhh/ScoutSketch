...
//     int count = 0;  // T = 1000
// 	uint64_t** Flow_list = new uint64_t*[1000];
// 	for (int i = 0; i < 1000; i++) {
// 		Flow_list[i] = new uint64_t[30000];
...
//     int count = 0;  // T = 300
// 	uint64_t** Flow_list = new uint64_t*[300];
// 	for (int i = 0; i < 300; i++) {
// 		Flow_list[i] = new uint64_t[100000];
...
//     int count = 0;  // T = 100
// 	uint64_t** Flow_list = new uint64_t*[100];
// 	for (int i = 0; i < 100; i++) {
// 		Flow_list[i] = new uint64_t[300000];
...
//     }
    ...
    // 创建一个包含5个元素的数组
    double arr1[5]={5,7.5,10,12.5,15};
    // 打印数组
